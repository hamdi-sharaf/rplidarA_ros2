...
def generate_launch_description():
    ...
    serial_baudrate_arg = DeclareLaunchArgument(
        ...
        description='Specifying usb port baudrate to connected lidar (C1 default: 460800)'
    )
    ...
    scan_mode_arg = DeclareLaunchArgument(
        ...
        description='Specifying scan mode of lidar (C1 default: Standard)'
    )
    
    # Angle limit arguments
